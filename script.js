...
let startSound = new Audio("gamestart-272829.mp3");
let tieSound = new Audio("mixkit-game-bonus-reached-2065.wav");
let victoryAudio = new Audio("mixkit-completion-of-a-level-2063.wav");
let clickSound = new Audio("mixkit-player-jumping-in-a-video-game-2043.wav");
let wrongClick = new Audio("error-126627.mp3");
